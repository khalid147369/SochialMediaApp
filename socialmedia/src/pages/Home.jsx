...
const Home = () => {
  ...
  return (
    ...
    <Layout
      ...
      className="  lg:max-w-5xl mx-auto md:p-10   overflow-y-auto "
    >
      <TextAreaCBT />
      ...
      <Layout className=" bg-transparent " >
        ...
        <Content
          ...
          className=" bg-transparent  mx-auto md:mx-0 h-fit w-fit flex flex-col  gap-10 md:items-center md:w-auto mb-20"
          style={{
            margin: "24px 25px",
            padding: 24,
            minHeight: 280,
